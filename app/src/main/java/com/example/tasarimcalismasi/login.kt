...
import com.example.tasarimcalismasi.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun UserLogin(){
        val UserEmail : String = binding.editTextText.text.toString()
        val UserPassword : String = binding.editTextText2.text.toString()
